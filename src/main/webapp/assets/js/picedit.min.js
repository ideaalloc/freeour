...
!function (i, t, e, a) {
    ...
    var n = "picEdit", o = {
        ...
        }, redirectUrl: !1, maxWidth: 400, maxHeight: "auto", aspectRatio: !0, defaultImage: !1
    };
    s.prototype = {
        init: function () {
            function a(i) {
                if (i || i.length) {
                    ...
                    e.onload = function (i) {
                        s._create_image_with_datasrc(i.target.result, !1, t)
                    }, e.readAsDataURL(t)
                }
            }

            var s = this, n = i(this.inputelement).prop("type");
            ...
            t = "undefined" != typeof t ? t : 3e3, e = "undefined" != typeof e ? e : !0;
            var a = "active";
            if (e || (a += " no_close_button"), t) {
            ...
            return this._messagebox.addClass(a).children("div").html(i)
            ...
            var i = this;
            this.set_loading(1).delay(200).promise().done(function () {
                var t = e.createElement("canvas"), a = t.getContext("2d");
            ...
            var e = this;
            (i = t.bind(navigator))({audio: !1, video: !0}, function (i) {
            ...
            var i = this, t = this._videobox.find("video")[0], a = e.createElement("canvas"), s = a.getContext("2d");
            ...
            var i = this._calculateCropWindow(), t = this;
            this.set_loading(1).delay(200).promise().done(function () {
                var a = e.createElement("canvas"), s = a.getContext("2d");
            ...
            var n = this, o = e.createElement("img");
            s && o.setAttribute("crossOrigin", "anonymous"), a && (o.file = a), o.src = i, o.onload = function () {
                if (s) {
                    var i = e.createElement("canvas"), a = i.getContext("2d");
                    i.width = o.width, i.height = o.height, a.drawImage(o, 0, 0), o.src = i.toDataURL("image/png")
                }
                n._image = o, n._resizeViewport(), n._paintCanvas(), n.options.imageUpdated(n._image), n._mainbuttons.removeClass("active"), t && "function" == typeof t && t()
            }
        }, _bindSelectionDrag: function () {
            var e = this, a = this._cropping.cropframe, s = this._painter, n = this._cropping.cropbox.find(".picedit_drag_resize_box_corner_wrap");
            ...
            var t = this._cropping.cropframe[0], e = i.clientX ? i : i.originalEvent.touches[0];
            ...
            var t = this._cropping.cropframe[0], e = i.pageX ? i : i.originalEvent.touches[0];
            ...
            var t = {}, e = i.target || i.srcElement, a = e.getBoundingClientRect(), s = i.clientX ? i : i.originalEvent.touches[0];
            ...
            var i = e.createElement("canvas"), t = i.getContext("2d"), a = this;
            ...
            var i = this._viewport, t = this._cropping.cropframe[0], e = {
            ...
            var t = this._image, e = {width: t.width, height: t.height};
            if ("auto" != this.options.maxWidth && t.width > this.options.maxWidth && (e.width = this.options.maxWidth), "auto" != this.options.maxHeight && t.height > this.options.maxHeight && (e.height = this.options.maxHeight), this.options.aspectRatio) {
                var a = t.width, s = t.height, n = a / s;
            ...
            if (t.FormData) {
                ...
                this.set_loading().delay(200).promise().done(function () {
                    if (e._theformdata = new FormData(e._theform[0]), e._image) {
                        var a = i(e.inputelement).prop("name") || "file", s = e._dataURItoBlob(e._image.src);
                        e._filename = e._filename ? e._filename.match(/^[^\.]*/) + "." + s.type.match(/[^\/]*$/) : s.type.replace("/", "."), e._theformdata.append(a, s, e._filename)
                    }
                    var n = new XMLHttpRequest;
                    n.onprogress = function (i) {
                        if (i.lengthComputable)var t = i.total; else var t = Math.ceil(1.3 * s.size);
                        var a = Math.ceil(i.loaded / t * 100);
                        a > 100 && (a = 100), e.set_messagebox("Please Wait... Uploading... " + a + "% Uploaded.", !1, !1)
                    }, n.open(e._theform.prop("method"), e._theform.prop("action"), !0), n.onload = function () {
